...
##########################################################################################################################################################################
# Pertinence des données : Matrice de corrélation 
##########################################################################################################################################################################
...
fifa_data['oportunity'] = ((fifa_data['overall_rating'] + fifa_data['potential'])/2) / fifa_data['release_clause_euro']
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# Entrainemant du model
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

# Definition des features sur lequel le model doit trouver la valeur du joueur
features = ['age', 'overall_rating', 'potential', 'international_reputation(1-5)', 'wage_euro',
            'release_clause_euro', 'reactions', 'composure','age_to_potential_ratio','performance_index','weighted_skill_score','weighted_shoot_score','prospect','oportunity']
targets = ['value_euro']
...
# Utilisation de Random Forest avec Cross-Validation pour le model
random_forest_model = RandomForestRegressor(n_estimators=100, random_state=42)

# Utilisation d'un KFold avec cross-validation pour 10 plis
kf = KFold(n_splits=10, shuffle=True, random_state=42)

# Calcul de RMSE and R²
...
##########################################################################################################################################################################
# Importances de données pour la value_euro
##########################################################################################################################################################################
